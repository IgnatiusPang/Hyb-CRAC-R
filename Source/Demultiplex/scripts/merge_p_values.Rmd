...
dataset_type <-    "JT_SM_20201011"   #  "SM_Only" # "JT_Only" #
...
```{r}
 list_of_files <- Sys.glob( "/media/ignatius/Dinosaur/Winton_CLASH/*/Processed_Data/Hyb_Annot/all_*.unique.hyb.p_values.tab" ) %>%
  discard( ~str_detect(. ,"control" ) )
