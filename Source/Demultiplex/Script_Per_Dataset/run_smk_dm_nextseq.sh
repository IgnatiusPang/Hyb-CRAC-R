...
# snakemake --dry-run --printshellcmds -j 12 --snakefile dm_nextseq.smk

snakemake -j 12 --printshellcmds --snakefile dm_nextseq.smk --cluster-config  cluster.json \
