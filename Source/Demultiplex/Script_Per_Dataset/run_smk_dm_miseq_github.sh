...
# snakemake --dry-run --printshellcmds -j 12 --snakefile merge_demultiplexv4.smk
# snakemake --unlock --printshellcmds -j 12 --snakefile dm_miseq.smk

snakemake -j 12 --printshellcmds --snakefile dm_miseq_github.smk --cluster-config  cluster.json \
...
# 
# snakemake \
# --snakefile merge_demultiplexv4.smk \
#  --dag \
#  | dot -Tpdf \
#  > dag.pdf
# 
